import {createTopic, createOldNews, criarNewNews, criarVid, newVid} from "./functionsCreate.js";

// Criação de matéria = criarNewNews("idDaMatéria", "Título da Matéria", "Conteúdo da Matéria", "Caminho para a imagem da matéria");

// Visita à sede do Senac
criarNewNews("sedeSenac", "Visita à Sede do Senac DF", 'Na última semana de existência da turma 160, ela protagonizou uma visita especial à sede do Senac, em um dia marcado por aprendizado, integração e novas perspectivas profissionais. A atividade, que faz parte do programa de formação continuada dos alunos, teve como objetivo aproximar a turma das estruturas e serviços que fortalecem a educação profissionalizante da instituição. Logo na chegada, os estudantes foram recebidos pela equipe pedagógica, que apresentou a história do Senac e sua atuação na formação de profissionais em diversas áreas. O grupo conheceu espaços internos, participou de uma visita guiada pelos laboratórios e pôde observar de perto o funcionamento dos setores administrativos. <br> Um dos momentos mais marcantes foi a conversa com coordenadores e instrutores, que compartilharam experiências de mercado, destacaram tendências das profissões e incentivaram os alunos a explorarem novas possibilidades dentro de suas áreas de estudo. A turma também teve a oportunidade de tirar dúvidas e conversar sobre carreira, projetos e estágio. Ao final da visita, ficou a certeza de que a experiência serviu como combustível para motivar os estudantes a seguirem firmes em sua formação.', "./src/sedeSenac.jpeg");
createTopic("sedeSenac", "Visita à Sede do Senac");

// Rotas
criarNewNews("Rotas", "Rotas para o Futuro Sobradinho - Técnico no Ensino Médio", ' O Senac Sobradinho promoveu, recentemente, o "Rotas para o Futuro", um evento dedicado a apresentar aos estudantes da região as diversas possibilidades de formação oferecidas pela instituição. A ação recebeu alunos de diferentes escolas, que tiveram a oportunidade de conhecer de perto os cursos, laboratórios, projetos e metodologias utilizadas no Senac. Durante a visita, os participantes foram guiados por instrutores, professores e jovens aprendizes, que desempenharam um papel essencial no acolhimento e na troca de experiências. Essa integração permitiu que os visitantes tirassem dúvidas, conhecessem a rotina dos cursos e vivenciassem, ainda que por alguns momentos, o ambiente profissionalizante da unidade. <br> Os jovens aprendizes que atuaram no apoio ao evento relataram que essa participação foi uma grande oportunidade de crescimento. Além de contribuir com a organização, puderam desenvolver habilidades de comunicação, responsabilidade e trabalho em equipe, vivenciando um contato direto com o público. Ao final da programação, muitos estudantes demonstraram interesse em seguir formações oferecidas pelo Senac, escolhendo cursos que mais combinaram com seu perfil e seus objetivos profissionais. O "Rotas para o Futuro" cumpriu seu propósito de orientar, inspirar e aproximar os jovens das oportunidades de educação profissional, reforçando o compromisso do Senac com a qualificação e o futuro da comunidade.', "./src/rotasSenac.jpeg");
createTopic("Rotas", "Rotas para o Futuro");
...
// Feira de Negócios: Alunos transformam ideias em projetos
createOldNews("ferNegoc", 'Feira de Negócios: Alunos Transformam Ideias em Projetos', 'Alunos da instrutora Eline organizam apresentações sobre seus projetos de empresas fictícias. A Feira de Negócios Vitrine do Empreendedorismo Estudantil, organizada pela instrutora Eline com alunos do curso Técnico em Administração, apresentou projetos de empresas fictícias desenvolvidos com ferramentas de gestão como Diagrama de Ishikawa, 5W2H e Project Model Canvas. Os estudantes criaram e expuseram negócios inovadores nas áreas de bem-estar, estética, moda e estilo de vida saudável, destacando empresas como 3SFit, Kativa SPA, Face Diamond, Lumiers Parfum e Perfect Fit.', './src/feiraNegocios.jpeg');

// CASO DE SUCESSO: Glaucya Pimentel
createOldNews('glayce', 'CASO DE SUCESSO: Glaucya Pimentel', 'Glaucya Pimentel, ex-aluna do Senac, compartilhou sua trajetória de capacitação e crescimento profissional. Com dedicação e busca por inovação, ela realizou vários cursos no Senac, incluindo Assistente Administrativo e Técnico em Secretariado. Hoje, como Técnica em Secretariado, Glaucya exerce funções estratégicas e destaca a importância da educação profissional para o sucesso. Sua história é um exemplo de como a capacitação pode transformar carreiras e abrir novas oportunidades.', './src/glaucya.jpeg');

// Entrevista com Curso Técnico em Administração
createOldNews('admInterview', 'Entrevista com Curso Técnico em Administração', 'No dia 12 de fevereiro, os jovens aprendizes da turma 153 do Senac Sobradinho entrevistaram a nova turma do curso Técnico em Administração. O objetivo foi compreender as expectativas e experiências dos novos estudantes. As entrevistas mostraram que os alunos aspiram a uma carreira profissional mais robusta e estão motivados a se profissionalizar ainda mais em suas áreas de interesse, demonstrando interesse por novas oportunidades.', './src/tecnicoAdm.jpeg');

// Visita de Ex-aluna de secretariado
createOldNews('secretariado', 'Visita de Ex-Aluna de Secretariado', 'Roberta, compartilha sua trajetória de sucesso com nova turma de secretariado. A ex-aluna Roberta, Secretária da Coordenação Geral de Desenvolvimento e Tecnologia do FNDE, ministrou uma aula prática sobre o sistema SEI 4.0 na Escola de Secretariado do Senac. Ela compartilhou sua experiência e rotina profissional, destacando a importância da organização e eficiência no trabalho de um Secretário. O evento fez parte do programa "Casos de Sucesso", que visa inspirar os alunos atuais com histórias de sucesso de ex-alunos.', './src/roberta.jpeg');

// Plataforma Digital do Senac: Cachola
createOldNews('cachola', 'Plataforma Digital do Senac: Cachola', 'O Senac lançou a plataforma digital Cachola, que oferece conteúdos em multiformato para transformar a experiência de ensino e aprendizagem. A plataforma reúne livros digitais, vídeos, podcasts e audiolivros, e está disponível para alunos e docentes do Senac via site ou aplicativo.', './src/cachola.jpeg');

// Entrevista com Turma de Modelagem
createOldNews('modelagem', 'Entrevista com Turma de Modelagem', 'No dia 21 de fevereiro, alguns jovens aprendizes da turma 153 realizaram uma entrevista a turma de modelagem, destacando histórias inspiradoras e talentos promissores. A sessão de perguntas e respostas permitiu que os alunos compartilhassem suas experiências e desafios na área da moda e criação, mostrando empolgação e comprometimento. A entrevista ressaltou a importância da modelagem na indústria da moda e demonstrou como a área segue em constante evolução, abrindo portas para talentos emergentes e proporcionando oportunidades para novas vozes se destacarem. A iniciativa serviu como registro do aprendizado e inspiração para futuros designers e modelistas.', './src/modelagemTurma.jpeg');

// Projeto Aprendiz Destaque do CEP Sobradinho
createOldNews('aprendizStar', 'Projeto Aprendiz Destaque do CEP Sobradinho', 'O projeto Aprendiz Destaque do Senac Sobradinho visa promover a excelência e o comprometimento dos jovens aprendizes. Os alunos são avaliados mensalmente por critérios como participação ativa, qualidade do trabalho, pontualidade e atitude positiva. No mês de fevereiro, os destaques foram: Marcelo Paz (turma da instrutora Marcia Rodrigues); Kellen Sayuri (turma da instrutora Adriana Pires) e Giovanna Santos (turma da instrutora Aline Lopes). O projeto busca incentivar a autoestima e a confiança em suas habilidades.', './src/projetoAprendizDestaque.jpeg');

// Entrevista com Jonathan, estudante de Técnico de Desenvolvimento em Sistemas do Senac
createOldNews('jonathan', 'Entrevista com Jonathan, Estudante de Técnico de Desenvolvimento em Sistemas do Senac', 'Jonathan, estudante de Técnico de Desenvolvimento em Sistemas do Senac, compartilhou sua paixão pela área de tecnologia e programação, especialmente no desenvolvimento de jogos. Ele está trabalhando em um projeto com sua turma que visa beneficiar todos no Senac e também desenvolveu um jogo de Pedra, Papel e Tesoura, onde destacou a lógica de programação como o maior desafio. Jonathan pretende continuar na área de tecnologia, se especializando em desenvolvimento de jogos e outras áreas relacionadas.', './src/Jonathan.jpeg');

// Entrevista com Nova Turma de Barbeiro
createOldNews('barman', 'Entrevista com Nova Turma de Barbeiro', 'No dia 14 de fevereiro, a turma de Jovem Aprendiz 153 do Senac entrevistou a nova turma de barbeiro da instrutora Cida. A entrevista teve como objetivo conhecer as expectativas e experiências dos novos alunos. Os futuros barbeiros destacaram a importância das aulas práticas oferecidas pelo Senac, que são essenciais para suas carreiras. Com paixão e determinação, eles estão prontos para deixar sua marca no mundo da beleza.','./src/barbeiro.jpeg');
